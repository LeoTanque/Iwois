...
@Component({
  selector: 'app-asignar-protocolo-paciente1',
  templateUrl: './asignar-protocolo-paciente1.page.html',
  styleUrls: ['./asignar-protocolo-paciente1.page.scss'],
})
export class AsignarProtocoloPaciente1Page implements OnInit {
