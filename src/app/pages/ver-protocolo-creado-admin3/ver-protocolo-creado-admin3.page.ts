...
@Component({
  selector: 'app-ver-protocolo-creado-admin3',
  templateUrl: './ver-protocolo-creado-admin3.page.html',
  styleUrls: ['./ver-protocolo-creado-admin3.page.scss'],
})
export class VerProtocoloCreadoAdmin3Page implements OnInit {
