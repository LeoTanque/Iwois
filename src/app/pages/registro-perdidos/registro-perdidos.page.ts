...
@Component({
  selector: 'app-registro-perdidos',
  templateUrl: './registro-perdidos.page.html',
  styleUrls: ['./registro-perdidos.page.scss'],
})
export class RegistroPerdidosPage implements OnInit {
