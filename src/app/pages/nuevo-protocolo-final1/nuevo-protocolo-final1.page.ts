...
@Component({
  selector: 'app-nuevo-protocolo-final1',
  templateUrl: './nuevo-protocolo-final1.page.html',
  styleUrls: ['./nuevo-protocolo-final1.page.scss'],
})
export class NuevoProtocoloFinal1Page implements OnInit {
