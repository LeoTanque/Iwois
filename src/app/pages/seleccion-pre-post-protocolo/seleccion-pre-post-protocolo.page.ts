...
@Component({
  selector: 'app-seleccion-pre-post-protocolo',
  templateUrl: './seleccion-pre-post-protocolo.page.html',
  styleUrls: ['./seleccion-pre-post-protocolo.page.scss'],
})
export class SeleccionPrePostProtocoloPage implements OnInit {
