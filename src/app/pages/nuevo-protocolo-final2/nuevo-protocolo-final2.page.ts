...
@Component({
  selector: 'app-nuevo-protocolo-final2',
  templateUrl: './nuevo-protocolo-final2.page.html',
  styleUrls: ['./nuevo-protocolo-final2.page.scss'],
})
export class NuevoProtocoloFinal2Page implements OnInit {
  tabs = [
