...
@Component({
  selector: 'app-nuevo-protocolo2',
  templateUrl: './nuevo-protocolo2.page.html',
  styleUrls: ['./nuevo-protocolo2.page.scss'],
})
export class NuevoProtocolo2Page implements OnInit {
