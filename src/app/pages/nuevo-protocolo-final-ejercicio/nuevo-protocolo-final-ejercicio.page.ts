...
@Component({
  selector: 'app-nuevo-protocolo-final-ejercicio',
  templateUrl: './nuevo-protocolo-final-ejercicio.page.html',
  styleUrls: ['./nuevo-protocolo-final-ejercicio.page.scss'],
})
export class NuevoProtocoloFinalEjercicioPage implements OnInit {
