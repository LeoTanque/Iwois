...
@Component({
  selector: 'app-nuevo-protocolo-suplementacion',
  templateUrl: './nuevo-protocolo-suplementacion.page.html',
  styleUrls: ['./nuevo-protocolo-suplementacion.page.scss'],
})
export class NuevoProtocoloSuplementacionPage implements OnInit {
