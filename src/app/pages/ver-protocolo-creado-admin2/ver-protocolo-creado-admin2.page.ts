...
@Component({
  selector: 'app-ver-protocolo-creado-admin2',
  templateUrl: './ver-protocolo-creado-admin2.page.html',
  styleUrls: ['./ver-protocolo-creado-admin2.page.scss'],
})
export class VerProtocoloCreadoAdmin2Page implements OnInit {
