...
@Component({
  selector: 'app-nuevo-protocolo-final',
  templateUrl: './nuevo-protocolo-final.page.html',
  styleUrls: ['./nuevo-protocolo-final.page.scss'],
})
export class NuevoProtocoloFinalPage implements OnInit {
