...
@Component({
  selector: 'app-nuevo-protocolo-ejercicio',
  templateUrl: './nuevo-protocolo-ejercicio.page.html',
  styleUrls: ['./nuevo-protocolo-ejercicio.page.scss'],
})
export class NuevoProtocoloEjercicioPage implements OnInit {
