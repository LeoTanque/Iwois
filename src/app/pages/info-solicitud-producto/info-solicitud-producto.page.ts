...
@Component({
  selector: 'app-info-solicitud-producto',
  templateUrl: './info-solicitud-producto.page.html',
  styleUrls: ['./info-solicitud-producto.page.scss'],
})
export class InfoSolicitudProductoPage implements OnInit {
