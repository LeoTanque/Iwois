...
@Component({
  selector: 'app-lista-protocolos-sin',
  templateUrl: './lista-protocolos-sin.page.html',
  styleUrls: ['./lista-protocolos-sin.page.scss'],
})
export class ListaProtocolosSinPage implements OnInit {
