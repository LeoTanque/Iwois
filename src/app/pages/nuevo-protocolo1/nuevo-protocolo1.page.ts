...
@Component({
  selector: 'app-nuevo-protocolo1',
  templateUrl: './nuevo-protocolo1.page.html',
  styleUrls: ['./nuevo-protocolo1.page.scss'],
})
export class NuevoProtocolo1Page implements OnInit {
